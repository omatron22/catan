...
function StylePreview({ style, type, color }: { style: BuildingStyle; type: "settlement" | "city"; color: string }) {
...
function RuleCard({ label, active, onClick, icon }: { label: string; active: boolean; onClick: () => void; icon: "robber" | "dice" }) {
  return (
    <button
      onClick={onClick}
